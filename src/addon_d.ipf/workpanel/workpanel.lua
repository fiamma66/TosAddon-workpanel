    ...
    EBI_try_catch {
        try = function()
            ...
            if isopen == false then
                ...
                .next("button", "btnchallenge400", 70, "460SO", "WORKPANEL_ENTER_CHALLENGE400")
                .next(
                    "richtext",
                    "dummy",
                    1,
                ...
                .upper("button", "btnchallenge440Solo", 70, "480SO", "WORKPANEL_ENTER_CHALLENGE440Solo")
                .under("button", "btnchallenge440Party", 70, "480PT", "WORKPANEL_ENTER_CHALLENGE440Party")
                .next(
                    "richtext",
                    "dummy_1",
                    1,
                 ...
                 .upper("button", "btngiltinesolo", 50,  "SOLO",
                 "WORKPANEL_ENTER_GILTINE_SOLO")
                 .under("button", "btngiltinepartyauto", 50,  "PT",
                "WORKPANEL_ENTER_GILTINE")
				 ...
				 .under(
                     ...
                     "btnspreaderweekly",
                     70,
                     "{ol}W " .. WORKPANEL_TICKET_STR("PVP_MINE_105"),
                     "WORKPANEL_BUYITEM_SPREADER",
                     WORKPANEL_GET_TICKET_PRICE("PVP_MINE_105")
                 )
				 .next(
                     "richtext",
                     "dummy2112",
				 ...
				 .upper("button", "btnspreadersolo", 70,  "SO:{/}"..WORKPANEL_GETINDUNENTERCOUNT(673),
				 "WORKPANEL_ENTER_SPREADER_SOLO")
                 .under("button", "btnspreaderparty", 70,  "PT:{/}"..WORKPANEL_GETINDUNENTERCOUNT(673),
                 "WORKPANEL_ENTER_SPREADER")
                 ...
                 .upper(
                     ...
                     "btndelmoresolo",
                     70,
                     "SO"..  GET_CURRENT_ENTERANCE_COUNT(GetClassByType("Indun", 667).PlayPerResetType) ..
				...
				.under(
                 ...
                 .upper("button", "btnjellyzele", 70,  "{/}SO:"..WORKPANEL_GETINDUNENTERCOUNT(672),
                 "WORKPANEL_ENTER_JELLYZELE_SOLO")
                 .under("button", "btnjellyzeleauto", 70,  "{/}PT:"..WORKPANEL_GETINDUNENTERCOUNT(671),
                 "WORKPANEL_ENTER_JELLYZELE")
                 ...
                 .upper(
                     ...
                     "label88",
                     100,
                     "{ol}Earing{/}:LEFT ".. GET_CURRENT_ENTERANCE_COUNT(GetClassByType("Indun", 661).PlayPerResetType),
                     ""
                 )
                 .under(
                     "button",
...
--                 -- )
                 ...
                 .upper("richtext", "label8", 70, "{ol}Assist", "")
                 .under(
                     "button",
                     "btnassister",
                     50,
                 ...
                 .upper("richtext", "label9", 100, "{ol}Bernice", "")
                 .under(
                     "button",
                     "btnvelniceweekly",
                     70,
...
function WORKPANEL_BUYITEM_SPREADER()
	WORKPANEL_BUYANDUSE("PVP_MINE_105", 673)
end
...
function WORKPANEL_ENTER_SPREADER(rep)
if WORKPANEL_ISINCITY() == false then
        ui.SysMsg("Cannot use outside city.")
        return
    end
...
function WORKPANEL_ENTER_SPREADER_SOLO(rep)
if WORKPANEL_ISINCITY() == false then
        ui.SysMsg("Cannot use outside city.")
        return
    end
	ReqRaidAutoUIOpen(674)
    ReserveScript("ReqMoveToIndun(1,0)", 1.25)
end
